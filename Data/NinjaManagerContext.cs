    ...
    public class NinjaManagerContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Equipment>().HasData(new Equipment
                {Name = "Fancy Hat", Cost = 300, Category = Category.Head});
            modelBuilder.Entity<Equipment>()
                .HasData(new Equipment {Name = "Pumpkin", Cost = 20, Category = Category.Head});
            modelBuilder.Entity<Equipment>().HasData(new Equipment
                {Name = "Diamond Chestplate", Cost = 800, Category = Category.Chest});
        }
    }
}